  ...
  useEffect(() => {
    ...
    const setupCall = async () => {
      try {
        ...
        // Set call start time from database and calculate initial waiting time
        const startTime = new Date(call.created_at).getTime();
        setCallStartTime(startTime);
        const initialWaitTime = Math.floor((Date.now() - startTime) / 1000);
        setWaitingTime(initialWaitTime);
      ...
      <div className="video-call-container waiting-room">
        <div className="waiting-content">
          <div className="waiting-icon">
            <img src={require('../images/time.png')} alt="Waiting" />
          </div>
