        ...
        <div className="landing-container">
            ...
            <nav className="navbar">
                <div className="navbar-content">
                    ...
                    <div className="nav-links">
                        ...
                        <button href="/signup" className="signup-btn" onClick={() => handleSignupClick()} style={{marginTop: '-20px'}}>Sign Up</button>
                    </div>
                    )}
                </div>
            </nav>
            ...
            <header className="hero-section">
                ...
                <div className="hero-image">
                    <img src={require('../images/doctor.jpg')} alt="Healthcare Illustration" />
                </div>
            </header>
